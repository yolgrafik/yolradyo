...
<div class="programlar-layout" style="max-width:1200px;margin:0 auto;padding:2rem 1rem;">
    <section class="programlar-hero" style="padding:2rem 0;margin-bottom:2rem;border-top:1px solid var(--ry-line-color);border-bottom:1px solid var(--ry-line-color);">
