    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        body {
            ...
            background: linear-gradient(180deg, #0d1017 0%, #151a24 100%);
            color: #f0f2f5;
            min-height: 100vh;
            display: flex;
        ...
        body.playing .disc-overlay { animation: spinDisc 2.5s linear infinite; }
        @keyframes spinDisc { from { transform: translate(-50%, -50%) rotate(0deg); } to { transform: translate(-50%, -50%) rotate(360deg); } }
        .player-track {
            font-weight: 800;
            font-size: 1rem;
            text-align: center;
...
<body>
    <div class="player-wrap">
        <div class="player-logo-wrap">
            <img src="{{ $playerLogo }}" class="logo-img" alt="{{ $siteName }}">
