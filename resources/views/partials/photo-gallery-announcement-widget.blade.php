...
.photo-gallery-announcement-card{display:none;position:relative;border:1px solid var(--border);border-radius:10px;overflow:hidden;background:rgba(255,255,255,.03);height:100%;min-height:325px;grid-template-rows:70% 30%;}
.photo-gallery-announcement-card.is-active{display:grid;}
.photo-gallery-announcement-card__image-btn{position:relative;display:block;width:100%;height:100%;padding:0;border:none;background:color-mix(in srgb,var(--ry-bar-bg) 88%, #0b0f16);cursor:zoom-in;overflow:hidden;}
...
.photo-gallery-announcement-card__body{position:relative;padding:10px 10px 9px;min-height:82px;max-height:100%;overflow:hidden;background:linear-gradient(to top, rgba(7,10,16,.9), rgba(7,10,16,.15));}
...
@media (max-width: 600px){
    ...
    .photo-gallery-announcement-card{min-height:292px;grid-template-rows:70% 30%;}
