...
.video-gallery-card__cover{position:relative;aspect-ratio:16/10;background:#10131a;overflow:hidden;flex:0 0 70%;}
.video-gallery-card__cover img{position:absolute;inset:0;width:100%;height:100%;object-fit:cover;display:block;}
...
.video-gallery-card__body{padding:6px 10px 8px;display:flex;flex-direction:column;justify-content:flex-end;align-items:flex-start;gap:4px;flex:0 0 30%;min-height:72px;margin-top:auto;}
