...
.video-gallery-card{display:flex;flex-direction:column;height:100%;background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.08);border-bottom:1px solid rgba(255,255,255,0.34);border-radius:12px;overflow:hidden;cursor:pointer;transition:transform .22s ease, box-shadow .22s ease, border-color .22s ease;}
...
.video-gallery-card__cover{position:relative;aspect-ratio:16/9;background:#10131a;overflow:hidden;min-height:70%;}
...
.video-gallery-card__body{padding:9px 12px;display:flex;flex-direction:column;justify-content:flex-start;align-items:flex-start;gap:5px;min-height:30%;max-height:30%;}
.video-gallery-card__title{margin:0;font-size:.95rem;font-weight:700;color:var(--text);line-height:1.35;}
.video-gallery-card__desc{margin:0;font-size:.8rem;line-height:1.45;color:var(--ry-text-muted);}
.video-gallery-widget{padding-bottom:3%;}
