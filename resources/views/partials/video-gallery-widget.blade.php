...
.video-gallery-swiper{padding:12px 12px 12px;}
...
.video-gallery-card__cover{position:relative;aspect-ratio:6/5;background:#10131a;overflow:hidden;flex:0 0 70%;}
...
.video-gallery-card__body{padding:10px 12px;display:flex;flex-direction:column;justify-content:flex-start;align-items:flex-start;gap:6px;flex:0 0 30%;min-height:108px;}
