...
<div class="module-grid">
    <a href="#" class="module-card module-card--red">
        <div class="module-card__header">
            ...
            <span class="module-card__title">Program & DJ</span>
        </div>
    ...
    <a href="#" class="module-card module-card--orange">
        <div class="module-card__header">
            ...
            <span class="module-card__title">Reklam Yonetimi</span>
        </div>
        <div class="module-card__body">
            <ul class="module-card__list">
    ...
    <a href="#" class="module-card module-card--blue">
        <div class="module-card__header">
            ...
            <span class="module-card__title">Mesaj & Istek</span>
        </div>
        <div class="module-card__body">
            <ul class="module-card__list">
    ...
    <a href="#" class="module-card module-card--green">
        <div class="module-card__header">
            ...
            <span class="module-card__title">Ayarlar</span>
        </div>
        <div class="module-card__body">
            <ul class="module-card__list">
    ...
    <a href="#" class="module-card module-card--purple">
        <div class="module-card__header">
            ...
            <span class="module-card__title">Kullanici Yonetimi</span>
        </div>
        <div class="module-card__body">
            <ul class="module-card__list">
