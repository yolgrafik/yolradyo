        ...
        <div class="main-row">
            <aside class="sidebar">
                ...
                <nav class="nav-accordion" id="navAccordion">
                    ...
                    <div class="nav-section {{ request()->routeIs('admin.members.*', 'admin.member-submissions.*', 'admin.member-settings.*', 'admin.mail-settings.*') ? 'is-open' : '' }}" data-section="uye">
                        <button class="nav-section__toggle" type="button" aria-expanded="{{ request()->routeIs('admin.members.*', 'admin.member-submissions.*', 'admin.member-settings.*', 'admin.mail-settings.*') ? 'true' : 'false' }}">
