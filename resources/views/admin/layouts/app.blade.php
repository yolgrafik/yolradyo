        ...
        <div class="main-row">
            <aside class="sidebar">
                ...
                <nav class="nav-accordion" id="navAccordion">
                    ...
                    <div class="nav-section {{ request()->routeIs('admin.members.*', 'admin.member-settings.*', 'admin.forum.*') ? 'is-open' : '' }}" data-section="forum-uye">
                        <button class="nav-section__toggle" type="button" aria-expanded="{{ request()->routeIs('admin.members.*', 'admin.member-settings.*', 'admin.forum.*') ? 'true' : 'false' }}">
                    ...
                    <div class="nav-section {{ request()->routeIs('admin.photo-gallery.*') ? 'is-open' : '' }}" data-section="foto">
                        ...
                        <ul class="nav-section__items">
                            ...
                            <li><a href="{{ route('admin.photo-gallery.albums.delete.list') }}" class="nav-item {{ request()->routeIs('admin.photo-gallery.albums.delete.list') ? 'is-active' : '' }}">Albüm Sil</a></li>
                    ...
                    <div class="nav-section {{ request()->routeIs('admin.sponsors.*') ? 'is-open' : '' }}" data-section="reklam">
                        <button class="nav-section__toggle" type="button" aria-expanded="{{ request()->routeIs('admin.sponsors.*') ? 'true' : 'false' }}">
                    ...
                    <div class="nav-section {{ request()->routeIs('admin.settings.*', 'admin.menu.*') ? 'is-open' : '' }}" data-section="ayarlar">
                        ...
                        <ul class="nav-section__items">
                            ...
                            <li><a href="{{ route('admin.settings.seo') }}" class="nav-item {{ request()->routeIs('admin.settings.seo') ? 'is-active' : '' }}">SEO Ayarları</a></li>
